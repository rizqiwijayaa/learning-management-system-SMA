...
import 'package:lms_guru/roles/kesiswaan/models/user_profile.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String get _initial {
    ...
    if (currentName.isEmpty) return 'K';
    ...
    final content = Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              _ProfileField(label: 'Nama', controller: _nameController, enabled: _isEditing),
              const SizedBox(height: 10),
              _ProfileField(label: 'Role', controller: _roleController, enabled: false),
              const SizedBox(height: 10),
              _ProfileField(label: 'NIP', controller: _nipController, enabled: false),
              const SizedBox(height: 10),
              _ProfileField(label: 'Email', controller: _emailController, enabled: false),
              const SizedBox(height: 10),
              _ProfileField(label: 'No. HP', controller: _phoneController, enabled: _isEditing),
            ],
          ),
        ),
        const SizedBox(height: 14),
        SizedBox(
          ...
          child: DecoratedBox(
            ...
            child: ElevatedButton(
              onPressed: _isSaving ? null : (_isEditing ? _saveProfile : _startEditing),
              ...
              child: Text(
                _isSaving ? 'Menyimpan...' : (_isEditing ? 'Simpan Perubahan' : 'Edit Profil'),
                maxLines: 1,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Informasi akun dan data kesiswaan',
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
      ...
      child: compact
          ? Column(
              ...
              children: [
                Row(
                  children: [
                    _ProfileAvatar(initial: initial, avatarBytes: avatarBytes, radius: 34),
                    const SizedBox(width: 12),
                    const Expanded(
                      child: Text(
                        'Foto profil kesiswaan',
                        maxLines: 2,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
...
class _HeaderCurveClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    final path = Path();
    path.moveTo(0, 40);
    path.quadraticBezierTo(size.width * 0.18, 60, size.width * 0.46, 46);
    path.quadraticBezierTo(size.width * 0.74, 24, size.width, 58);
