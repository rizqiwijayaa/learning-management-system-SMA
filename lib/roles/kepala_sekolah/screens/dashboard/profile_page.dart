...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    _roleController = TextEditingController(text: 'Kepala Sekolah');
  ...
  void _applyProfile(UserProfile profile) {
    setState(() {
      ...
      _roleController.text = 'Kepala Sekolah';
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (!mounted) return;
      _applyProfile(saved.copyWith(role: 'Kepala Sekolah'));
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Profil kepala sekolah berhasil disimpan.')),
      );
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Informasi akun dan data kepala sekolah',
                          style: TextStyle(
